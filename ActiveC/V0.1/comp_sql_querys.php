...
*/
	...
	if($func=="9") 
	{
		...
		echo "
			...
			<input type=\"button\" value =\"+\" id = 'add_skill' class='skills' onclick='addSkillToList(document.getElementById(\"skill_input\").value)'></input>
        ...
        echo "</datalist>
                <button type=\"submit\" id=\"conf_skill\" class='skills'>filter</button>
                </form>";
	}
