...
if($func=="1")
{
	...
	foreach ($databaseConnection->query($sql) as $row)
	{
		...
		if($row['phone_number']!=="")
		{
			...
			$phone_pic = "<div> 
				<img id='std_phone_' src=\"./img/telephoneIcon.jpg\" width='35' height='35' onclick='$(\"#phoneDiv\").html(".$zero.$phone_number.");'/>
				</div>";
		}
		...
		if($row['Email']!=="")
		{
			$$mail_pic=$row['Email'];
			$mail_pic = "<div> 
				<img id='std_mail_' src=\"./img/mailIcon.png\" width='35' height='35' onclick='$(\"#mailDiv\").html(" . $maito_string . ");'/>
				</div>";
		}
