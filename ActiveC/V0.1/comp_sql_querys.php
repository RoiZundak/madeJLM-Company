<?php
	...
	if($func=="1")
	{
		...
		foreach ($databaseConnection->query($sql) as $row) 
		{
			...
			$sentence="Studies for a ".$degree_name." in ".$row[basic_education_subject]." at ".$college_name." for ".$row['basic_education_subject']." with ".$row['semesters_left']." semesters left";
			echo "
			<table>
			    <tr>
			        <td>
